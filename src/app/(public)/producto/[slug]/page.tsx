        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-baseline gap-3">
              ...
              <span className="text-sm text-[#00FF88] font-medium drop-shadow-[0_0_6px_rgba(0,255,136,0.5)]">COP</span>
              {hasDiscount && (
                  ...
                  <Link href={`/producto/${relatedProduct.slug}`}>
                    ...
                    <CardContent className="p-4">
                      ...
                      <p className="text-lg font-bold text-[#00FF88] mt-1 drop-shadow-[0_0_6px_rgba(0,255,136,0.4)]">
                        {formatPrice(relatedProduct.price)} <span className="text-xs text-[#00FF88] font-medium drop-shadow-[0_0_6px_rgba(0,255,136,0.5)]">COP</span>
                      </p>
                    </CardContent>
                  </Link>
                </Card>
