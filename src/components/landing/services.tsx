...
export function Services() {
  return (
    <section id="servicios" className="py-24 bg-[#0A1628]">
        ...
        <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-6" staggerDelay={0.1}>
          {services.map((service, index) => (
            <StaggerItem key={index}>
              <Card className="group hover:shadow-lg hover:shadow-[#00FF88]/10 hover:border-[#00FF88]/30 transition-all duration-300 border-[#1E3A5F] bg-[#1E3A5F]/50 h-full">
                <CardContent className="p-6">
                  <div className="w-14 h-14 rounded-xl border-2 border-[#2A4A6F] flex items-center justify-center mb-4 group-hover:border-[#00FF88] group-hover:bg-[#00FF88]/10 group-hover:shadow-[0_0_20px_rgba(0,255,136,0.3)] transition-all duration-300">
                    <service.icon className="w-7 h-7 text-white group-hover:text-[#00FF88] group-hover:drop-shadow-[0_0_8px_rgba(0,255,136,0.8)] transition-all duration-300" />
                  </div>
