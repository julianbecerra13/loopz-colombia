...
export function FeaturedProducts({ products }: FeaturedProductsProps) {
  return (
    <section className="py-24 bg-white dark:bg-[#0A1628] border-t border-gray-100 dark:border-[#1E3A5F]">
      <div className="container mx-auto px-4">
        ...
        <FadeIn className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
          ...
          <Button variant="outline" asChild className="self-start md:self-auto border-gray-300 dark:border-[#2A4A6F] text-[#0A1628] dark:text-white hover:bg-gray-50 dark:hover:bg-[#1E3A5F]">
