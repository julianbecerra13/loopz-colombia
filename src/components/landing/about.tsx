        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <ScaleIn className="relative">
            <div className="relative aspect-square max-w-sm mx-auto">
              ...
              {/* Main card */}
              <div className="relative bg-[#1E3A5F] rounded-3xl p-8 h-full flex flex-col justify-center items-center border-2 border-[#2A4A6F] shadow-lg">
                ...
                <p className="text-gray-300 text-center text-sm">
                  Liderando el mercado de audio premium en Colombia
                </p>
              </div>
            </div>

            {/* Floating stat cards */}
            <div className="absolute -bottom-4 -left-4 bg-[#1E3A5F] rounded-xl p-4 shadow-lg border border-[#2A4A6F]">
          ...
          <FadeIn direction="right" className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              En Loopz Colombia, somos más que una tienda de audio. Somos una comunidad de
