...
export function About() {
  return (
    <section id="nosotros" className="py-24 bg-[#0A1628] border-t border-[#1E3A5F]">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <ScaleIn className="relative">
            <div className="relative aspect-square max-w-sm mx-auto">
              {/* Borde decorativo */}
              <div className="absolute inset-0 rounded-3xl border-2 border-dashed border-[#1E3A5F] transform rotate-3" />

              {/* Main card */}
              <div className="relative bg-white bg-[#1E3A5F] rounded-3xl p-8 h-full flex flex-col justify-center items-center border-2 border-gray-100 border-[#2A4A6F] shadow-lg">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Años de Experiencia</h3>
                <p className="text-gray-500 text-gray-300 text-center text-sm">
            ...
            {/* Floating stat cards */}
            <div className="absolute -bottom-4 -left-4 bg-white bg-[#1E3A5F] rounded-xl p-4 shadow-lg border border-gray-100 border-[#2A4A6F]">
              <div className="text-2xl font-bold text-white">50K+</div>
              <div className="text-sm text-gray-500 text-gray-300">Clientes satisfechos</div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3 pt-4">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 text-gray-300 text-sm">{feature}</span>
                </div>
              ))}
            </div>
          </FadeIn>
